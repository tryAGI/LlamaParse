...
namespace LlamaParse
{
    public partial class AlphaClient
    {
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement s_ListVerifyJobsApiAlphaVerifyGetSecurityRequirement0 =
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement[] s_ListVerifyJobsApiAlphaVerifyGetSecurityRequirements =
            new global::LlamaParse.EndPointSecurityRequirement[]
            {                s_ListVerifyJobsApiAlphaVerifyGetSecurityRequirement0,
            };
        partial void PrepareListVerifyJobsApiAlphaVerifyGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            int? pageSize,
            ref string? pageToken,
            global::LlamaParse.ListVerifyJobsApiAlphaVerifyGetStatus2? status,
            ...
            ref string? session);
        partial void PrepareListVerifyJobsApiAlphaVerifyGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::System.DateTime? createdAtOnOrBefore,
            string? session);
        partial void ProcessListVerifyJobsApiAlphaVerifyGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListVerifyJobsApiAlphaVerifyGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LlamaParse.VerifyJobQueryResponse> ListVerifyJobsApiAlphaVerifyGetAsync(
        ...
        {
            var __response = await ListVerifyJobsApiAlphaVerifyGetAsResponseAsync(
                pageSize: pageSize,
                pageToken: pageToken,
                status: status,
                jobIds: jobIds,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LlamaParse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.VerifyJobQueryResponse>> ListVerifyJobsApiAlphaVerifyGetAsResponseAsync(
            int? pageSize = default,
            string? pageToken = default,
            global::LlamaParse.ListVerifyJobsApiAlphaVerifyGetStatus2? status = default,
            global::System.Collections.Generic.IList<string>? jobIds = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListVerifyJobsApiAlphaVerifyGetArguments(
            ...
            var __authorizations = global::LlamaParse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListVerifyJobsApiAlphaVerifyGetSecurityRequirements,
                operationName: "ListVerifyJobsApiAlphaVerifyGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListVerifyJobsApiAlphaVerifyGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LlamaParse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListVerifyJobsApiAlphaVerifyGet",
                                methodName: "ListVerifyJobsApiAlphaVerifyGetAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListVerifyJobsApiAlphaVerifyGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListVerifyJobsApiAlphaVerifyGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LlamaParse.VerifyJobQueryResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.VerifyJobQueryResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LlamaParse.VerifyJobQueryResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
