...
namespace LlamaParse
{
    public partial class RetrievalClient
    {
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement s_SearchFilesApiV1RetrievalFilesSearchPostSecurityRequirement0 =
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement[] s_SearchFilesApiV1RetrievalFilesSearchPostSecurityRequirements =
            new global::LlamaParse.EndPointSecurityRequirement[]
            {                s_SearchFilesApiV1RetrievalFilesSearchPostSecurityRequirement0,
            };
        partial void PrepareSearchFilesApiV1RetrievalFilesSearchPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Guid? projectId,
            global::System.Guid? organizationId,
            ref string? session,
            global::LlamaParse.FileSearchParams request);
        partial void PrepareSearchFilesApiV1RetrievalFilesSearchPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? session,
            global::LlamaParse.FileSearchParams request);
        partial void ProcessSearchFilesApiV1RetrievalFilesSearchPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSearchFilesApiV1RetrievalFilesSearchPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LlamaParse.FileSearchApiResponse> SearchFilesApiV1RetrievalFilesSearchPostAsync(
        ...
        {
            var __response = await SearchFilesApiV1RetrievalFilesSearchPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LlamaParse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.FileSearchApiResponse>> SearchFilesApiV1RetrievalFilesSearchPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSearchFilesApiV1RetrievalFilesSearchPostArguments(
            ...
            var __authorizations = global::LlamaParse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SearchFilesApiV1RetrievalFilesSearchPostSecurityRequirements,
                operationName: "SearchFilesApiV1RetrievalFilesSearchPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSearchFilesApiV1RetrievalFilesSearchPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LlamaParse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SearchFilesApiV1RetrievalFilesSearchPost",
                                methodName: "SearchFilesApiV1RetrievalFilesSearchPostAsync",
                                pathTemplate: "\"/api/v1/retrieval/files/search\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSearchFilesApiV1RetrievalFilesSearchPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSearchFilesApiV1RetrievalFilesSearchPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LlamaParse.FileSearchApiResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.FileSearchApiResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LlamaParse.FileSearchApiResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::LlamaParse.FileSearchApiResponse> SearchFilesApiV1RetrievalFilesSearchPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::LlamaParse.FileSearchParams
            {
                IndexId = indexId,
                FileName = fileName,
            ...
            return await SearchFilesApiV1RetrievalFilesSearchPostAsync(
                projectId: projectId,
                organizationId: organizationId,
                session: session,
                request: __request,
