    ...
    public static class AutoModeParsingConfVersionExtensions
    {
        ...
        public static string ToValueString(this AutoModeParsingConfVersion value)
        {
            return value switch
            {
                ...
                AutoModeParsingConfVersion.x20260330 => "2026-03-30",
                AutoModeParsingConfVersion.x20260331 => "2026-03-31",
                AutoModeParsingConfVersion.x20260402 => "2026-04-02",
                AutoModeParsingConfVersion.x20260406 => "2026-04-06",
                AutoModeParsingConfVersion.x20260409 => "2026-04-09",
                AutoModeParsingConfVersion.x20260414 => "2026-04-14",
                AutoModeParsingConfVersion.x20260419 => "2026-04-19",
                AutoModeParsingConfVersion.x20260422 => "2026-04-22",
                AutoModeParsingConfVersion.x20260427 => "2026-04-27",
        ...
        public static AutoModeParsingConfVersion? ToEnum(string value)
        {
            return value switch
            {
                ...
                "2026-03-30" => AutoModeParsingConfVersion.x20260330,
                "2026-03-31" => AutoModeParsingConfVersion.x20260331,
                "2026-04-02" => AutoModeParsingConfVersion.x20260402,
                "2026-04-06" => AutoModeParsingConfVersion.x20260406,
                "2026-04-09" => AutoModeParsingConfVersion.x20260409,
                "2026-04-14" => AutoModeParsingConfVersion.x20260414,
                "2026-04-19" => AutoModeParsingConfVersion.x20260419,
                "2026-04-22" => AutoModeParsingConfVersion.x20260422,
                "2026-04-27" => AutoModeParsingConfVersion.x20260427,
