    ...
    public static class AutoModeParsingConfVersionExtensions
    {
        ...
        public static string ToValueString(this AutoModeParsingConfVersion value)
        {
            return value switch
            {
                ...
                AutoModeParsingConfVersion.x20260528 => "2026-05-28",
                AutoModeParsingConfVersion.x20260601 => "2026-06-01",
        ...
        public static AutoModeParsingConfVersion? ToEnum(string value)
        {
            return value switch
            {
                ...
                "2026-05-28" => AutoModeParsingConfVersion.x20260528,
                "2026-06-01" => AutoModeParsingConfVersion.x20260601,
