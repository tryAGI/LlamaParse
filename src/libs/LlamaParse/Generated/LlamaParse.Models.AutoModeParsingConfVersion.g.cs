    ...
    public static class AutoModeParsingConfVersionExtensions
    {
        ...
        public static string ToValueString(this AutoModeParsingConfVersion value)
        {
            return value switch
            {
                ...
                AutoModeParsingConfVersion.x20260511 => "2026-05-11",
                AutoModeParsingConfVersion.x20260513 => "2026-05-13",
        ...
        public static AutoModeParsingConfVersion? ToEnum(string value)
        {
            return value switch
            {
                ...
                "2026-05-11" => AutoModeParsingConfVersion.x20260511,
                "2026-05-13" => AutoModeParsingConfVersion.x20260513,
