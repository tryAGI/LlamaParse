...
namespace LlamaParse
{
    public partial class BetaClient
    {
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement s_SearchAgentDataApiV1BetaAgentDataSearchPostSecurityRequirement0 =
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement[] s_SearchAgentDataApiV1BetaAgentDataSearchPostSecurityRequirements =
            new global::LlamaParse.EndPointSecurityRequirement[]
            {                s_SearchAgentDataApiV1BetaAgentDataSearchPostSecurityRequirement0,
            };
        partial void PrepareSearchAgentDataApiV1BetaAgentDataSearchPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Guid? projectId,
            global::System.Guid? organizationId,
            ref string? session,
            global::LlamaParse.SearchRequest request);
        partial void PrepareSearchAgentDataApiV1BetaAgentDataSearchPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? session,
            global::LlamaParse.SearchRequest request);
        partial void ProcessSearchAgentDataApiV1BetaAgentDataSearchPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSearchAgentDataApiV1BetaAgentDataSearchPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSearchAgentDataApiV1BetaAgentDataSearchPostArguments(
            ...
            var __authorizations = global::LlamaParse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SearchAgentDataApiV1BetaAgentDataSearchPostSecurityRequirements,
                operationName: "SearchAgentDataApiV1BetaAgentDataSearchPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSearchAgentDataApiV1BetaAgentDataSearchPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LlamaParse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SearchAgentDataApiV1BetaAgentDataSearchPost",
                                methodName: "SearchAgentDataApiV1BetaAgentDataSearchPostAsync",
                                pathTemplate: "\"/api/v1/beta/agent-data/:search\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSearchAgentDataApiV1BetaAgentDataSearchPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSearchAgentDataApiV1BetaAgentDataSearchPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::LlamaParse.PaginatedResponseAgentData.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::LlamaParse.PaginatedResponseAgentData.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await SearchAgentDataApiV1BetaAgentDataSearchPostAsync(
                projectId: projectId,
                organizationId: organizationId,
                session: session,
                request: __request,
