...
{
    /// <inheritdoc />
    public class MetadataScalarValueJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::LlamaParse.MetadataScalarValue>
    {
        /// <inheritdoc />
        public override global::LlamaParse.MetadataScalarValue Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            string? metadataScalarValueVariant1 = default;
            int? metadataScalarValueVariant2 = default;
            double? metadataScalarValueVariant3 = default;
            bool? metadataScalarValueVariant4 = default;
            object? metadataScalarValueVariant5 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        metadataScalarValueVariant1 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        metadataScalarValueVariant2 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
                ...
                else if (__bestIndex == 2)
                {
                    try
                    {
                        ...
                        metadataScalarValueVariant3 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
                ...
                else if (__bestIndex == 3)
                {
                    try
                    {
                        ...
                        metadataScalarValueVariant4 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
                ...
                else if (__bestIndex == 4)
                {
                    try
                    {
                        ...
                        metadataScalarValueVariant5 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (metadataScalarValueVariant1 == null && metadataScalarValueVariant2 == null && metadataScalarValueVariant3 == null && metadataScalarValueVariant4 == null && metadataScalarValueVariant5 == null)
            {
                try
                {
            ...
            var __value = new global::LlamaParse.MetadataScalarValue(
        ...
        public override void Write(
            ...
            global::LlamaParse.MetadataScalarValue value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsMetadataScalarValueVariant1)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(string), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<string?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(string).Name}");
