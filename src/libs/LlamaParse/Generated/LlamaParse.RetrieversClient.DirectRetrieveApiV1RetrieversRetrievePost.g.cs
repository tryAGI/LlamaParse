...
namespace LlamaParse
{
    public partial class RetrieversClient
    {
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement s_DirectRetrieveApiV1RetrieversRetrievePostSecurityRequirement0 =
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement[] s_DirectRetrieveApiV1RetrieversRetrievePostSecurityRequirements =
            new global::LlamaParse.EndPointSecurityRequirement[]
            {                s_DirectRetrieveApiV1RetrieversRetrievePostSecurityRequirement0,
            };
        partial void PrepareDirectRetrieveApiV1RetrieversRetrievePostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Guid? projectId,
            global::System.Guid? organizationId,
            ref string? session,
            global::LlamaParse.DirectRetrievalParams request);
        partial void PrepareDirectRetrieveApiV1RetrieversRetrievePostRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? session,
            global::LlamaParse.DirectRetrievalParams request);
        partial void ProcessDirectRetrieveApiV1RetrieversRetrievePostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDirectRetrieveApiV1RetrieversRetrievePostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LlamaParse.CompositeRetrievalResult> DirectRetrieveApiV1RetrieversRetrievePostAsync(
        ...
        {
            var __response = await DirectRetrieveApiV1RetrieversRetrievePostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LlamaParse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.CompositeRetrievalResult>> DirectRetrieveApiV1RetrieversRetrievePostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareDirectRetrieveApiV1RetrieversRetrievePostArguments(
            ...
            var __authorizations = global::LlamaParse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DirectRetrieveApiV1RetrieversRetrievePostSecurityRequirements,
                operationName: "DirectRetrieveApiV1RetrieversRetrievePostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDirectRetrieveApiV1RetrieversRetrievePostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LlamaParse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DirectRetrieveApiV1RetrieversRetrievePost",
                                methodName: "DirectRetrieveApiV1RetrieversRetrievePostAsync",
                                pathTemplate: "\"/api/v1/retrievers/retrieve\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDirectRetrieveApiV1RetrieversRetrievePostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDirectRetrieveApiV1RetrieversRetrievePostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LlamaParse.CompositeRetrievalResult.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.CompositeRetrievalResult>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LlamaParse.CompositeRetrievalResult.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::LlamaParse.CompositeRetrievalResult> DirectRetrieveApiV1RetrieversRetrievePostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::LlamaParse.DirectRetrievalParams
            {
                Mode = mode,
            ...
            return await DirectRetrieveApiV1RetrieversRetrievePostAsync(
                projectId: projectId,
                organizationId: organizationId,
                session: session,
                request: __request,
