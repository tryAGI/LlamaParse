...
namespace LlamaParse
{
    public partial class AlphaClient
    {
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement s_CreateVerifyJobApiAlphaVerifyPostSecurityRequirement0 =
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement[] s_CreateVerifyJobApiAlphaVerifyPostSecurityRequirements =
            new global::LlamaParse.EndPointSecurityRequirement[]
            {                s_CreateVerifyJobApiAlphaVerifyPostSecurityRequirement0,
            };
        partial void PrepareCreateVerifyJobApiAlphaVerifyPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Guid? projectId,
            global::System.Guid? organizationId,
            ref string? session,
            global::LlamaParse.VerifyRequest request);
        partial void PrepareCreateVerifyJobApiAlphaVerifyPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? session,
            global::LlamaParse.VerifyRequest request);
        partial void ProcessCreateVerifyJobApiAlphaVerifyPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateVerifyJobApiAlphaVerifyPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LlamaParse.VerifyJobResponse> CreateVerifyJobApiAlphaVerifyPostAsync(
        ...
        {
            var __response = await CreateVerifyJobApiAlphaVerifyPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LlamaParse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.VerifyJobResponse>> CreateVerifyJobApiAlphaVerifyPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateVerifyJobApiAlphaVerifyPostArguments(
            ...
            var __authorizations = global::LlamaParse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateVerifyJobApiAlphaVerifyPostSecurityRequirements,
                operationName: "CreateVerifyJobApiAlphaVerifyPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateVerifyJobApiAlphaVerifyPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LlamaParse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateVerifyJobApiAlphaVerifyPost",
                                methodName: "CreateVerifyJobApiAlphaVerifyPostAsync",
                                pathTemplate: "\"/api/alpha/verify\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateVerifyJobApiAlphaVerifyPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateVerifyJobApiAlphaVerifyPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::LlamaParse.VerifyJobResponse> CreateVerifyJobApiAlphaVerifyPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::LlamaParse.VerifyRequest
            {
            ...
            return await CreateVerifyJobApiAlphaVerifyPostAsync(
                projectId: projectId,
                organizationId: organizationId,
                session: session,
                request: __request,
