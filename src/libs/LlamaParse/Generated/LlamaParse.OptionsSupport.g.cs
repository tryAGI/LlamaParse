...
namespace LlamaParse
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::LlamaParse.AutoSDKRetryOptions Retry { get; set; } = new global::LlamaParse.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::LlamaParse.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::LlamaParse.IAutoSDKHook>();
        ...
        public global::LlamaParse.AutoSDKClientOptions AddHook(
            global::LlamaParse.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::LlamaParse.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::LlamaParse.AutoSDKClientOptions UseAuthorizationProvider(
            global::LlamaParse.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::LlamaParse.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::LlamaParse.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::LlamaParse.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::LlamaParse.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::LlamaParse.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::LlamaParse.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::LlamaParse.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::LlamaParse.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::LlamaParse.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::LlamaParse.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::LlamaParse.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::LlamaParse.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::LlamaParse.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::LlamaParse.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::LlamaParse.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::LlamaParse.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::LlamaParse.AutoSDKClientOptions clientOptions,
            global::LlamaParse.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::LlamaParse.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::LlamaParse.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::LlamaParse.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::LlamaParse.AutoSDKClientOptions clientOptions,
            global::System.Func<global::LlamaParse.IAutoSDKHook, global::LlamaParse.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::LlamaParse.AutoSDKHookContext context)
        {
