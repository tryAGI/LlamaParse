    ...
    public static class ParseRequestConfigurationVersionExtensions
    {
        ...
        public static string ToValueString(this ParseRequestConfigurationVersion value)
        {
            return value switch
            {
                ...
                ParseRequestConfigurationVersion.x20260909 => "2026-09-09",
                ParseRequestConfigurationVersion.x20260911 => "2026-09-11",
        ...
        public static ParseRequestConfigurationVersion? ToEnum(string value)
        {
            return value switch
            {
                ...
                "2026-09-09" => ParseRequestConfigurationVersion.x20260909,
                "2026-09-11" => ParseRequestConfigurationVersion.x20260911,
