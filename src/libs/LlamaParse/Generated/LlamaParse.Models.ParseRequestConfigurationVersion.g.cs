    ...
    public static class ParseRequestConfigurationVersionExtensions
    {
        ...
        public static string ToValueString(this ParseRequestConfigurationVersion value)
        {
            return value switch
            {
                ...
                ParseRequestConfigurationVersion.x20260611 => "2026-06-11",
                ParseRequestConfigurationVersion.x20260617 => "2026-06-17",
        ...
        public static ParseRequestConfigurationVersion? ToEnum(string value)
        {
            return value switch
            {
                ...
                "2026-06-11" => ParseRequestConfigurationVersion.x20260611,
                "2026-06-17" => ParseRequestConfigurationVersion.x20260617,
