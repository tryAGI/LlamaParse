    ...
    public static class ParseRequestConfigurationVersionExtensions
    {
        ...
        public static string ToValueString(this ParseRequestConfigurationVersion value)
        {
            return value switch
            {
                ...
                ParseRequestConfigurationVersion.x20260511 => "2026-05-11",
                ParseRequestConfigurationVersion.x20260513 => "2026-05-13",
        ...
        public static ParseRequestConfigurationVersion? ToEnum(string value)
        {
            return value switch
            {
                ...
                "2026-05-11" => ParseRequestConfigurationVersion.x20260511,
                "2026-05-13" => ParseRequestConfigurationVersion.x20260513,
