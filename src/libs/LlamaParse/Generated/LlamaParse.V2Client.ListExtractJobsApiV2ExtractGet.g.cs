...
namespace LlamaParse
{
    public partial class V2Client
    {
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement s_ListExtractJobsApiV2ExtractGetSecurityRequirement0 =
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement[] s_ListExtractJobsApiV2ExtractGetSecurityRequirements =
            new global::LlamaParse.EndPointSecurityRequirement[]
            {                s_ListExtractJobsApiV2ExtractGetSecurityRequirement0,
            };
        partial void PrepareListExtractJobsApiV2ExtractGetArguments(
            ...
            ref global::LlamaParse.ListExtractJobsApiV2ExtractGetStatus? status,
            int? pageSize,
        ...
        partial void PrepareListExtractJobsApiV2ExtractGetRequest(
            ...
            global::LlamaParse.ListExtractJobsApiV2ExtractGetStatus? status,
            int? pageSize,
            string? pageToken,
            global::System.Collections.Generic.IList<string>? jobIds,
            global::System.Collections.Generic.IList<string>? expand,
        ...
        public async global::System.Threading.Tasks.Task<global::LlamaParse.ExtractV2JobQueryResponse> ListExtractJobsApiV2ExtractGetAsync(
            ...
            global::LlamaParse.ListExtractJobsApiV2ExtractGetStatus? status = default,
        ...
        {
            var __response = await ListExtractJobsApiV2ExtractGetAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LlamaParse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.ExtractV2JobQueryResponse>> ListExtractJobsApiV2ExtractGetAsResponseAsync(
            string? documentInputType = default,
            string? fileInput = default,
            string? documentInputValue = default,
            global::LlamaParse.ListExtractJobsApiV2ExtractGetStatus? status = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LlamaParse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListExtractJobsApiV2ExtractGet",
                                methodName: "ListExtractJobsApiV2ExtractGetAsync",
                    ...
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LlamaParse.ExtractV2JobQueryResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.ExtractV2JobQueryResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LlamaParse.ExtractV2JobQueryResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
