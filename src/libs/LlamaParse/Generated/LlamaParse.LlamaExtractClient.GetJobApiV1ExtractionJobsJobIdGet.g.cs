...
namespace LlamaParse
{
    public partial class LlamaExtractClient
    {
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement s_GetJobApiV1ExtractionJobsJobIdGetSecurityRequirement0 =
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement[] s_GetJobApiV1ExtractionJobsJobIdGetSecurityRequirements =
            new global::LlamaParse.EndPointSecurityRequirement[]
            {                s_GetJobApiV1ExtractionJobsJobIdGetSecurityRequirement0,
            };
        ...
        partial void ProcessGetJobApiV1ExtractionJobsJobIdGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::LlamaParse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetJobApiV1ExtractionJobsJobIdGetSecurityRequirements,
                operationName: "GetJobApiV1ExtractionJobsJobIdGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetJobApiV1ExtractionJobsJobIdGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LlamaParse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetJobApiV1ExtractionJobsJobIdGet",
                                methodName: "GetJobApiV1ExtractionJobsJobIdGetAsync",
                                pathTemplate: "$\"/api/v1/extraction/jobs/{jobId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetJobApiV1ExtractionJobsJobIdGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetJobApiV1ExtractionJobsJobIdGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
