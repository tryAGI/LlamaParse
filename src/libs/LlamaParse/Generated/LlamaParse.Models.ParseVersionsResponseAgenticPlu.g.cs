    ...
    public static class ParseVersionsResponseAgenticPluExtensions
    {
        ...
        public static string ToValueString(this ParseVersionsResponseAgenticPlu value)
        {
            return value switch
            {
                ...
                ParseVersionsResponseAgenticPlu.x20260506 => "2026-05-06",
                ParseVersionsResponseAgenticPlu.x20260511 => "2026-05-11",
                ParseVersionsResponseAgenticPlu.x20260519 => "2026-05-19",
                ParseVersionsResponseAgenticPlu.x20260520 => "2026-05-20",
                ParseVersionsResponseAgenticPlu.x20260521 => "2026-05-21",
                ParseVersionsResponseAgenticPlu.x20260526 => "2026-05-26",
                ParseVersionsResponseAgenticPlu.x20260601 => "2026-06-01",
                ParseVersionsResponseAgenticPlu.x20260604 => "2026-06-04",
                ParseVersionsResponseAgenticPlu.x20260611 => "2026-06-11",
                ParseVersionsResponseAgenticPlu.x20260618 => "2026-06-18",
                ParseVersionsResponseAgenticPlu.x20260708 => "2026-07-08",
        ...
        public static ParseVersionsResponseAgenticPlu? ToEnum(string value)
        {
            return value switch
            {
                ...
                "2026-05-06" => ParseVersionsResponseAgenticPlu.x20260506,
                "2026-05-11" => ParseVersionsResponseAgenticPlu.x20260511,
                "2026-05-19" => ParseVersionsResponseAgenticPlu.x20260519,
                "2026-05-20" => ParseVersionsResponseAgenticPlu.x20260520,
                "2026-05-21" => ParseVersionsResponseAgenticPlu.x20260521,
                "2026-05-26" => ParseVersionsResponseAgenticPlu.x20260526,
                "2026-06-01" => ParseVersionsResponseAgenticPlu.x20260601,
                "2026-06-04" => ParseVersionsResponseAgenticPlu.x20260604,
                "2026-06-11" => ParseVersionsResponseAgenticPlu.x20260611,
                "2026-06-18" => ParseVersionsResponseAgenticPlu.x20260618,
                "2026-07-08" => ParseVersionsResponseAgenticPlu.x20260708,
                _ => null,
            };
        }
    }
