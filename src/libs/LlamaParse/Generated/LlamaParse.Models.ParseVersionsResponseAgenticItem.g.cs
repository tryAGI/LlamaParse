    ...
    public static class ParseVersionsResponseAgenticItemExtensions
    {
        ...
        public static string ToValueString(this ParseVersionsResponseAgenticItem value)
        {
            return value switch
            {
                ...
                ParseVersionsResponseAgenticItem.x20260506 => "2026-05-06",
                ParseVersionsResponseAgenticItem.x20260511 => "2026-05-11",
                ParseVersionsResponseAgenticItem.x20260513 => "2026-05-13",
                ParseVersionsResponseAgenticItem.x20260519 => "2026-05-19",
                ParseVersionsResponseAgenticItem.x20260520 => "2026-05-20",
                ParseVersionsResponseAgenticItem.x20260521 => "2026-05-21",
                ParseVersionsResponseAgenticItem.x20260526 => "2026-05-26",
                ParseVersionsResponseAgenticItem.x20260601 => "2026-06-01",
                ParseVersionsResponseAgenticItem.x20260604 => "2026-06-04",
                ParseVersionsResponseAgenticItem.x20260611 => "2026-06-11",
                ParseVersionsResponseAgenticItem.x20260618 => "2026-06-18",
                ParseVersionsResponseAgenticItem.x20260715 => "2026-07-15",
                ParseVersionsResponseAgenticItem.x20260723 => "2026-07-23",
                ParseVersionsResponseAgenticItem.x20260724 => "2026-07-24",
        ...
        public static ParseVersionsResponseAgenticItem? ToEnum(string value)
        {
            return value switch
            {
                ...
                "2026-05-06" => ParseVersionsResponseAgenticItem.x20260506,
                "2026-05-11" => ParseVersionsResponseAgenticItem.x20260511,
                "2026-05-13" => ParseVersionsResponseAgenticItem.x20260513,
                "2026-05-19" => ParseVersionsResponseAgenticItem.x20260519,
                "2026-05-20" => ParseVersionsResponseAgenticItem.x20260520,
                "2026-05-21" => ParseVersionsResponseAgenticItem.x20260521,
                "2026-05-26" => ParseVersionsResponseAgenticItem.x20260526,
                "2026-06-01" => ParseVersionsResponseAgenticItem.x20260601,
                "2026-06-04" => ParseVersionsResponseAgenticItem.x20260604,
                "2026-06-11" => ParseVersionsResponseAgenticItem.x20260611,
                "2026-06-18" => ParseVersionsResponseAgenticItem.x20260618,
                "2026-07-15" => ParseVersionsResponseAgenticItem.x20260715,
                "2026-07-23" => ParseVersionsResponseAgenticItem.x20260723,
                "2026-07-24" => ParseVersionsResponseAgenticItem.x20260724,
