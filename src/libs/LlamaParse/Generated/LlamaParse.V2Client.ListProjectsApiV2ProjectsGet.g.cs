...
namespace LlamaParse
{
    public partial class V2Client
    {
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement s_ListProjectsApiV2ProjectsGetSecurityRequirement0 =
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement[] s_ListProjectsApiV2ProjectsGetSecurityRequirements =
            new global::LlamaParse.EndPointSecurityRequirement[]
            {                s_ListProjectsApiV2ProjectsGetSecurityRequirement0,
            };
        partial void PrepareListProjectsApiV2ProjectsGetArguments(
            ...
            ref string? session);
        partial void PrepareListProjectsApiV2ProjectsGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? pageToken,
            string? session);
        partial void ProcessListProjectsApiV2ProjectsGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListProjectsApiV2ProjectsGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LlamaParse.ProjectQueryResponse> ListProjectsApiV2ProjectsGetAsync(
        ...
        {
            var __response = await ListProjectsApiV2ProjectsGetAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LlamaParse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.ProjectQueryResponse>> ListProjectsApiV2ProjectsGetAsResponseAsync(
            string? organizationId = default,
            string? name = default,
            int? pageSize = default,
            string? pageToken = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListProjectsApiV2ProjectsGetArguments(
            ...
            var __authorizations = global::LlamaParse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListProjectsApiV2ProjectsGetSecurityRequirements,
                operationName: "ListProjectsApiV2ProjectsGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListProjectsApiV2ProjectsGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LlamaParse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListProjectsApiV2ProjectsGet",
                                methodName: "ListProjectsApiV2ProjectsGetAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListProjectsApiV2ProjectsGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListProjectsApiV2ProjectsGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LlamaParse.ProjectQueryResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.ProjectQueryResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LlamaParse.ProjectQueryResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
