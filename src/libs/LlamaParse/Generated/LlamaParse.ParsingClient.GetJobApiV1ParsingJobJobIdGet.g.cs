...
namespace LlamaParse
{
    public partial class ParsingClient
    {
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement s_GetJobApiV1ParsingJobJobIdGetSecurityRequirement0 =
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement[] s_GetJobApiV1ParsingJobJobIdGetSecurityRequirements =
            new global::LlamaParse.EndPointSecurityRequirement[]
            {                s_GetJobApiV1ParsingJobJobIdGetSecurityRequirement0,
            };
        partial void PrepareGetJobApiV1ParsingJobJobIdGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string jobId,
            global::System.Guid? projectId,
            global::System.Guid? organizationId,
            ref string? session);
        partial void PrepareGetJobApiV1ParsingJobJobIdGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::System.Guid? organizationId,
            string? session);
        partial void ProcessGetJobApiV1ParsingJobJobIdGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetJobApiV1ParsingJobJobIdGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LlamaParse.ParsingJob> GetJobApiV1ParsingJobJobIdGetAsync(
            string jobId,
        ...
        {
            var __response = await GetJobApiV1ParsingJobJobIdGetAsResponseAsync(
                jobId: jobId,
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LlamaParse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.ParsingJob>> GetJobApiV1ParsingJobJobIdGetAsResponseAsync(
            string jobId,
            global::System.Guid? projectId = default,
            global::System.Guid? organizationId = default,
            string? session = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetJobApiV1ParsingJobJobIdGetArguments(
            ...
            var __authorizations = global::LlamaParse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetJobApiV1ParsingJobJobIdGetSecurityRequirements,
                operationName: "GetJobApiV1ParsingJobJobIdGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetJobApiV1ParsingJobJobIdGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LlamaParse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetJobApiV1ParsingJobJobIdGet",
                                methodName: "GetJobApiV1ParsingJobJobIdGetAsync",
                                pathTemplate: "$\"/api/v1/parsing/job/{jobId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetJobApiV1ParsingJobJobIdGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetJobApiV1ParsingJobJobIdGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
