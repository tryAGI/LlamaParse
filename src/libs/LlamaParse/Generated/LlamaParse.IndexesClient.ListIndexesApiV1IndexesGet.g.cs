...
namespace LlamaParse
{
    public partial class IndexesClient
    {
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement s_ListIndexesApiV1IndexesGetSecurityRequirement0 =
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement[] s_ListIndexesApiV1IndexesGetSecurityRequirements =
            new global::LlamaParse.EndPointSecurityRequirement[]
            {                s_ListIndexesApiV1IndexesGetSecurityRequirement0,
            };
        partial void PrepareListIndexesApiV1IndexesGetArguments(
            ...
            ref string? session);
        partial void PrepareListIndexesApiV1IndexesGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? pageToken,
            string? session);
        partial void ProcessListIndexesApiV1IndexesGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListIndexesApiV1IndexesGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LlamaParse.IndexQueryResponse> ListIndexesApiV1IndexesGetAsync(
        ...
        {
            var __response = await ListIndexesApiV1IndexesGetAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LlamaParse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.IndexQueryResponse>> ListIndexesApiV1IndexesGetAsResponseAsync(
            global::System.Guid? projectId = default,
            global::System.Guid? organizationId = default,
            string? sourceDirectoryId = default,
            int? pageSize = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListIndexesApiV1IndexesGetArguments(
            ...
            var __authorizations = global::LlamaParse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListIndexesApiV1IndexesGetSecurityRequirements,
                operationName: "ListIndexesApiV1IndexesGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListIndexesApiV1IndexesGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LlamaParse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListIndexesApiV1IndexesGet",
                                methodName: "ListIndexesApiV1IndexesGetAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListIndexesApiV1IndexesGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListIndexesApiV1IndexesGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LlamaParse.IndexQueryResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.IndexQueryResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LlamaParse.IndexQueryResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
