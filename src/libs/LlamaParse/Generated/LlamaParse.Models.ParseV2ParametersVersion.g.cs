    ...
    public static class ParseV2ParametersVersionExtensions
    {
        ...
        public static string ToValueString(this ParseV2ParametersVersion value)
        {
            return value switch
            {
                ...
                ParseV2ParametersVersion.x20260511 => "2026-05-11",
                ParseV2ParametersVersion.x20260513 => "2026-05-13",
        ...
        public static ParseV2ParametersVersion? ToEnum(string value)
        {
            return value switch
            {
                ...
                "2026-05-11" => ParseV2ParametersVersion.x20260511,
                "2026-05-13" => ParseV2ParametersVersion.x20260513,
