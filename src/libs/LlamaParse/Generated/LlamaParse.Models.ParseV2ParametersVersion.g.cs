    ...
    public static class ParseV2ParametersVersionExtensions
    {
        ...
        public static string ToValueString(this ParseV2ParametersVersion value)
        {
            return value switch
            {
                ...
                ParseV2ParametersVersion.x20260526 => "2026-05-26",
                ParseV2ParametersVersion.x20260528 => "2026-05-28",
        ...
        public static ParseV2ParametersVersion? ToEnum(string value)
        {
            return value switch
            {
                ...
                "2026-05-26" => ParseV2ParametersVersion.x20260526,
                "2026-05-28" => ParseV2ParametersVersion.x20260528,
