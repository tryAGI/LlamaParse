    ...
    public static class ParseV2ParametersVersionExtensions
    {
        ...
        public static string ToValueString(this ParseV2ParametersVersion value)
        {
            return value switch
            {
                ...
                ParseV2ParametersVersion.x20260911 => "2026-09-11",
                ParseV2ParametersVersion.x20260913 => "2026-09-13",
        ...
        public static ParseV2ParametersVersion? ToEnum(string value)
        {
            return value switch
            {
                ...
                "2026-09-11" => ParseV2ParametersVersion.x20260911,
                "2026-09-13" => ParseV2ParametersVersion.x20260913,
