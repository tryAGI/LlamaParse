    ...
    public static class ParseV2ParametersVersionExtensions
    {
        ...
        public static string ToValueString(this ParseV2ParametersVersion value)
        {
            return value switch
            {
                ...
                ParseV2ParametersVersion.x20260611 => "2026-06-11",
                ParseV2ParametersVersion.x20260617 => "2026-06-17",
        ...
        public static ParseV2ParametersVersion? ToEnum(string value)
        {
            return value switch
            {
                ...
                "2026-06-11" => ParseV2ParametersVersion.x20260611,
                "2026-06-17" => ParseV2ParametersVersion.x20260617,
