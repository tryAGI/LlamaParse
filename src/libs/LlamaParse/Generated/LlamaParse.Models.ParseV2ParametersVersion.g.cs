    ...
    public static class ParseV2ParametersVersionExtensions
    {
        ...
        public static string ToValueString(this ParseV2ParametersVersion value)
        {
            return value switch
            {
                ...
                ParseV2ParametersVersion.x20260723 => "2026-07-23",
                ParseV2ParametersVersion.x20260724 => "2026-07-24",
        ...
        public static ParseV2ParametersVersion? ToEnum(string value)
        {
            return value switch
            {
                ...
                "2026-07-23" => ParseV2ParametersVersion.x20260723,
                "2026-07-24" => ParseV2ParametersVersion.x20260724,
