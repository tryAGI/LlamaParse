...
namespace LlamaParse
{
    public partial class SheetsClient
    {
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement s_GetSpreadsheetJobApiV1SheetsJobsSpreadsheetJobIdGetSecurityRequirement0 =
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement[] s_GetSpreadsheetJobApiV1SheetsJobsSpreadsheetJobIdGetSecurityRequirements =
            new global::LlamaParse.EndPointSecurityRequirement[]
            {                s_GetSpreadsheetJobApiV1SheetsJobsSpreadsheetJobIdGetSecurityRequirement0,
            };
        partial void PrepareGetSpreadsheetJobApiV1SheetsJobsSpreadsheetJobIdGetArguments(
            ...
            ref string? session);
        partial void PrepareGetSpreadsheetJobApiV1SheetsJobsSpreadsheetJobIdGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::System.Guid? organizationId,
            string? session);
        partial void ProcessGetSpreadsheetJobApiV1SheetsJobsSpreadsheetJobIdGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetSpreadsheetJobApiV1SheetsJobsSpreadsheetJobIdGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LlamaParse.SpreadsheetJob> GetSpreadsheetJobApiV1SheetsJobsSpreadsheetJobIdGetAsync(
            string spreadsheetJobId,
        ...
        {
            var __response = await GetSpreadsheetJobApiV1SheetsJobsSpreadsheetJobIdGetAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LlamaParse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.SpreadsheetJob>> GetSpreadsheetJobApiV1SheetsJobsSpreadsheetJobIdGetAsResponseAsync(
            string spreadsheetJobId,
            bool? includeResults = default,
            global::System.Collections.Generic.IList<string>? expand = default,
            global::System.Guid? projectId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetSpreadsheetJobApiV1SheetsJobsSpreadsheetJobIdGetArguments(
            ...
            var __authorizations = global::LlamaParse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetSpreadsheetJobApiV1SheetsJobsSpreadsheetJobIdGetSecurityRequirements,
                operationName: "GetSpreadsheetJobApiV1SheetsJobsSpreadsheetJobIdGetAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LlamaParse.PathBuilder(
                                path: $"/api/v1/sheets/jobs/{spreadsheetJobId}",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetSpreadsheetJobApiV1SheetsJobsSpreadsheetJobIdGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LlamaParse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetSpreadsheetJobApiV1SheetsJobsSpreadsheetJobIdGet",
                                methodName: "GetSpreadsheetJobApiV1SheetsJobsSpreadsheetJobIdGetAsync",
                                pathTemplate: "$\"/api/v1/sheets/jobs/{spreadsheetJobId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetSpreadsheetJobApiV1SheetsJobsSpreadsheetJobIdGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetSpreadsheetJobApiV1SheetsJobsSpreadsheetJobIdGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LlamaParse.SpreadsheetJob.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.SpreadsheetJob>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LlamaParse.SpreadsheetJob.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
