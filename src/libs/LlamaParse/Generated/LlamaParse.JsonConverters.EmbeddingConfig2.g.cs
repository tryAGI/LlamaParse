...
{
    /// <inheritdoc />
    public class EmbeddingConfig2JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::LlamaParse.EmbeddingConfig2>
    {
        /// <inheritdoc />
        public override global::LlamaParse.EmbeddingConfig2 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::LlamaParse.EmbeddingModelConfigCreateEmbeddingConfigDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::LlamaParse.EmbeddingModelConfigCreateEmbeddingConfigDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::LlamaParse.EmbeddingModelConfigCreateEmbeddingConfigDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::LlamaParse.AzureOpenAIEmbeddingConfig? azureEmbedding1 = default;
            if (discriminator?.Type == global::LlamaParse.EmbeddingModelConfigCreateEmbeddingConfigDiscriminatorType.AzureEmbedding)
            {
            ...
            if (discriminator?.Type == global::LlamaParse.EmbeddingModelConfigCreateEmbeddingConfigDiscriminatorType.CohereEmbedding)
            {
            ...
            if (discriminator?.Type == global::LlamaParse.EmbeddingModelConfigCreateEmbeddingConfigDiscriminatorType.GeminiEmbedding)
            {
            ...
            if (discriminator?.Type == global::LlamaParse.EmbeddingModelConfigCreateEmbeddingConfigDiscriminatorType.HuggingfaceApiEmbedding)
            {
            ...
            if (discriminator?.Type == global::LlamaParse.EmbeddingModelConfigCreateEmbeddingConfigDiscriminatorType.VertexaiEmbedding)
            {
            ...
            if (discriminator?.Type == global::LlamaParse.EmbeddingModelConfigCreateEmbeddingConfigDiscriminatorType.BedrockEmbedding)
            {
            ...
            var __value = new global::LlamaParse.EmbeddingConfig2(
                discriminator?.Type,
                azureEmbedding1,
        ...
        public override void Write(
            ...
            global::LlamaParse.EmbeddingConfig2 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
