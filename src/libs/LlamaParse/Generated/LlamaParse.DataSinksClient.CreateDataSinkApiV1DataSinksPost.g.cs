...
namespace LlamaParse
{
    public partial class DataSinksClient
    {
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement s_CreateDataSinkApiV1DataSinksPostSecurityRequirement0 =
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement[] s_CreateDataSinkApiV1DataSinksPostSecurityRequirements =
            new global::LlamaParse.EndPointSecurityRequirement[]
            {                s_CreateDataSinkApiV1DataSinksPostSecurityRequirement0,
            };
        partial void PrepareCreateDataSinkApiV1DataSinksPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Guid? projectId,
            global::System.Guid? organizationId,
            ref string? session,
            global::LlamaParse.DataSinkCreate request);
        partial void PrepareCreateDataSinkApiV1DataSinksPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? session,
            global::LlamaParse.DataSinkCreate request);
        partial void ProcessCreateDataSinkApiV1DataSinksPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateDataSinkApiV1DataSinksPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LlamaParse.DataSink> CreateDataSinkApiV1DataSinksPostAsync(
        ...
        {
            var __response = await CreateDataSinkApiV1DataSinksPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LlamaParse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.DataSink>> CreateDataSinkApiV1DataSinksPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateDataSinkApiV1DataSinksPostArguments(
            ...
            var __authorizations = global::LlamaParse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateDataSinkApiV1DataSinksPostSecurityRequirements,
                operationName: "CreateDataSinkApiV1DataSinksPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateDataSinkApiV1DataSinksPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LlamaParse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateDataSinkApiV1DataSinksPost",
                                methodName: "CreateDataSinkApiV1DataSinksPostAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateDataSinkApiV1DataSinksPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateDataSinkApiV1DataSinksPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LlamaParse.DataSink.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.DataSink>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LlamaParse.DataSink.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::LlamaParse.DataSink> CreateDataSinkApiV1DataSinksPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::LlamaParse.DataSinkCreate
            {
                Name = name,
                SinkType = sinkType,
                Component = component,
            ...
            return await CreateDataSinkApiV1DataSinksPostAsync(
                projectId: projectId,
                organizationId: organizationId,
                session: session,
                request: __request,
