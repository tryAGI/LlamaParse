...
namespace LlamaParse
{
    public partial class DataSourcesClient
    {
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement s_CreateDataSourceApiV1DataSourcesPostSecurityRequirement0 =
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement[] s_CreateDataSourceApiV1DataSourcesPostSecurityRequirements =
            new global::LlamaParse.EndPointSecurityRequirement[]
            {                s_CreateDataSourceApiV1DataSourcesPostSecurityRequirement0,
            };
        ...
        public async global::System.Threading.Tasks.Task<global::LlamaParse.DataSource> CreateDataSourceApiV1DataSourcesPostAsync(
        ...
        {
            var __response = await CreateDataSourceApiV1DataSourcesPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LlamaParse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.DataSource>> CreateDataSourceApiV1DataSourcesPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::LlamaParse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateDataSourceApiV1DataSourcesPostSecurityRequirements,
                operationName: "CreateDataSourceApiV1DataSourcesPostAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LlamaParse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateDataSourceApiV1DataSourcesPost",
                                methodName: "CreateDataSourceApiV1DataSourcesPostAsync",
                    ...
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LlamaParse.DataSource.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.DataSource>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LlamaParse.DataSource.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
