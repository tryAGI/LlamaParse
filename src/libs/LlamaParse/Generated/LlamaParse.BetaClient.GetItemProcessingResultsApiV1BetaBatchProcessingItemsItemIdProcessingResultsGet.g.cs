...
namespace LlamaParse
{
    public partial class BetaClient
    {
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement s_GetItemProcessingResultsApiV1BetaBatchProcessingItemsItemIdProcessingResultsGetSecurityRequirement0 =
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement[] s_GetItemProcessingResultsApiV1BetaBatchProcessingItemsItemIdProcessingResultsGetSecurityRequirements =
            new global::LlamaParse.EndPointSecurityRequirement[]
            {                s_GetItemProcessingResultsApiV1BetaBatchProcessingItemsItemIdProcessingResultsGetSecurityRequirement0,
            };
        partial void PrepareGetItemProcessingResultsApiV1BetaBatchProcessingItemsItemIdProcessingResultsGetArguments(
            ...
            ref string? session);
        partial void PrepareGetItemProcessingResultsApiV1BetaBatchProcessingItemsItemIdProcessingResultsGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::System.Guid? organizationId,
            string? session);
        partial void ProcessGetItemProcessingResultsApiV1BetaBatchProcessingItemsItemIdProcessingResultsGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetItemProcessingResultsApiV1BetaBatchProcessingItemsItemIdProcessingResultsGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LlamaParse.ItemProcessingResultsResponse> GetItemProcessingResultsApiV1BetaBatchProcessingItemsItemIdProcessingResultsGetAsync(
            string itemId,
        ...
        {
            var __response = await GetItemProcessingResultsApiV1BetaBatchProcessingItemsItemIdProcessingResultsGetAsResponseAsync(
                itemId: itemId,
                jobType: jobType,
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LlamaParse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.ItemProcessingResultsResponse>> GetItemProcessingResultsApiV1BetaBatchProcessingItemsItemIdProcessingResultsGetAsResponseAsync(
            string itemId,
            global::LlamaParse.BatchJobType? jobType = default,
            global::System.Guid? projectId = default,
            global::System.Guid? organizationId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetItemProcessingResultsApiV1BetaBatchProcessingItemsItemIdProcessingResultsGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LlamaParse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetItemProcessingResultsApiV1BetaBatchProcessingItemsItemIdProcessingResultsGet",
                                methodName: "GetItemProcessingResultsApiV1BetaBatchProcessingItemsItemIdProcessingResultsGetAsync",
                                pathTemplate: "$\"/api/v1/beta/batch-processing/items/{itemId}/processing-results\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetItemProcessingResultsApiV1BetaBatchProcessingItemsItemIdProcessingResultsGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetItemProcessingResultsApiV1BetaBatchProcessingItemsItemIdProcessingResultsGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LlamaParse.ItemProcessingResultsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.ItemProcessingResultsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LlamaParse.ItemProcessingResultsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
