...
namespace LlamaParse
{
    public partial interface IParsingClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LlamaParse.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.PresignedUrl>> GeneratePresignedUrlApiV1ParsingJobJobIdReadFilenameGetAsResponseAsync(
            string jobId,
            string filename,
            string? session = default,
            global::LlamaParse.AutoSDKRequestOptions? requestOptions = default,
