            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::LlamaParse.FileIdPresignedUrl.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::LlamaParse.FileIdPresignedUrl.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
