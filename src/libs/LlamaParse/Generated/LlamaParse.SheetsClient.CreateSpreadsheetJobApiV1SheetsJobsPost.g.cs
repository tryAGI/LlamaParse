...
namespace LlamaParse
{
    public partial class SheetsClient
    {
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement s_CreateSpreadsheetJobApiV1SheetsJobsPostSecurityRequirement0 =
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement[] s_CreateSpreadsheetJobApiV1SheetsJobsPostSecurityRequirements =
            new global::LlamaParse.EndPointSecurityRequirement[]
            {                s_CreateSpreadsheetJobApiV1SheetsJobsPostSecurityRequirement0,
            };
        partial void PrepareCreateSpreadsheetJobApiV1SheetsJobsPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Guid? projectId,
            global::System.Guid? organizationId,
            ref string? session,
            global::LlamaParse.SpreadsheetJobCreate request);
        partial void PrepareCreateSpreadsheetJobApiV1SheetsJobsPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? session,
            global::LlamaParse.SpreadsheetJobCreate request);
        partial void ProcessCreateSpreadsheetJobApiV1SheetsJobsPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateSpreadsheetJobApiV1SheetsJobsPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LlamaParse.SpreadsheetJob> CreateSpreadsheetJobApiV1SheetsJobsPostAsync(
        ...
        {
            var __response = await CreateSpreadsheetJobApiV1SheetsJobsPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LlamaParse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.SpreadsheetJob>> CreateSpreadsheetJobApiV1SheetsJobsPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateSpreadsheetJobApiV1SheetsJobsPostArguments(
            ...
            var __authorizations = global::LlamaParse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateSpreadsheetJobApiV1SheetsJobsPostSecurityRequirements,
                operationName: "CreateSpreadsheetJobApiV1SheetsJobsPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateSpreadsheetJobApiV1SheetsJobsPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LlamaParse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateSpreadsheetJobApiV1SheetsJobsPost",
                                methodName: "CreateSpreadsheetJobApiV1SheetsJobsPostAsync",
                                pathTemplate: "\"/api/v1/sheets/jobs\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateSpreadsheetJobApiV1SheetsJobsPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateSpreadsheetJobApiV1SheetsJobsPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreateSpreadsheetJobApiV1SheetsJobsPostAsync(
                projectId: projectId,
                organizationId: organizationId,
                session: session,
                request: __request,
