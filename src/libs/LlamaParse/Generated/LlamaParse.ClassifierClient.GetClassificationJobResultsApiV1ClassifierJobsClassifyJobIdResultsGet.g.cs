            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::LlamaParse.ClassifyJobResults.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::LlamaParse.ClassifyJobResults.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
