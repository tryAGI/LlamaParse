...
{
    /// <inheritdoc />
    public class EmbeddingConfigVariant1JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::LlamaParse.EmbeddingConfigVariant1>
    {
        /// <inheritdoc />
        public override global::LlamaParse.EmbeddingConfigVariant1 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::LlamaParse.EmbeddingModelConfigUpdateEmbeddingConfigVariant1Discriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::LlamaParse.EmbeddingModelConfigUpdateEmbeddingConfigVariant1Discriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::LlamaParse.EmbeddingModelConfigUpdateEmbeddingConfigVariant1Discriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::LlamaParse.AzureOpenAIEmbeddingConfig? azureEmbedding1 = default;
            if (discriminator?.Type == global::LlamaParse.EmbeddingModelConfigUpdateEmbeddingConfigVariant1DiscriminatorType.AzureEmbedding)
            {
            ...
            if (discriminator?.Type == global::LlamaParse.EmbeddingModelConfigUpdateEmbeddingConfigVariant1DiscriminatorType.CohereEmbedding)
            {
            ...
            if (discriminator?.Type == global::LlamaParse.EmbeddingModelConfigUpdateEmbeddingConfigVariant1DiscriminatorType.GeminiEmbedding)
            {
            ...
            if (discriminator?.Type == global::LlamaParse.EmbeddingModelConfigUpdateEmbeddingConfigVariant1DiscriminatorType.HuggingfaceApiEmbedding)
            {
            ...
            if (discriminator?.Type == global::LlamaParse.EmbeddingModelConfigUpdateEmbeddingConfigVariant1DiscriminatorType.VertexaiEmbedding)
            {
            ...
            if (discriminator?.Type == global::LlamaParse.EmbeddingModelConfigUpdateEmbeddingConfigVariant1DiscriminatorType.BedrockEmbedding)
            {
            ...
            var __value = new global::LlamaParse.EmbeddingConfigVariant1(
                discriminator?.Type,
                azureEmbedding1,
        ...
        public override void Write(
            ...
            global::LlamaParse.EmbeddingConfigVariant1 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
