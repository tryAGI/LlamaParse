...
namespace LlamaParse
{
    public partial class FilesClient
    {
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement s_GetFileApiV1FilesIdGetSecurityRequirement0 =
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement[] s_GetFileApiV1FilesIdGetSecurityRequirements =
            new global::LlamaParse.EndPointSecurityRequirement[]
            {                s_GetFileApiV1FilesIdGetSecurityRequirement0,
            };
        partial void PrepareGetFileApiV1FilesIdGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid id,
            global::System.Guid? projectId,
            global::System.Guid? organizationId,
            ref string? session);
        partial void PrepareGetFileApiV1FilesIdGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::System.Guid? organizationId,
            string? session);
        partial void ProcessGetFileApiV1FilesIdGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetFileApiV1FilesIdGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LlamaParse.File> GetFileApiV1FilesIdGetAsync(
            global::System.Guid id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetFileApiV1FilesIdGetArguments(
            ...
            var __authorizations = global::LlamaParse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetFileApiV1FilesIdGetSecurityRequirements,
                operationName: "GetFileApiV1FilesIdGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetFileApiV1FilesIdGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LlamaParse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetFileApiV1FilesIdGet",
                                methodName: "GetFileApiV1FilesIdGetAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetFileApiV1FilesIdGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetFileApiV1FilesIdGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::LlamaParse.File.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::LlamaParse.File.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
