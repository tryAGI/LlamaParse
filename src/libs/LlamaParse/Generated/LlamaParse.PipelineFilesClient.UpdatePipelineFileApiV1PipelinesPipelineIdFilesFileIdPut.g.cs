...
namespace LlamaParse
{
    public partial class PipelineFilesClient
    {
        ...
        {
            var __response = await UpdatePipelineFileApiV1PipelinesPipelineIdFilesFileIdPutAsResponseAsync(
                fileId: fileId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LlamaParse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.PipelineFile>> UpdatePipelineFileApiV1PipelinesPipelineIdFilesFileIdPutAsResponseAsync(
            global::System.Guid fileId,
            global::System.Guid pipelineId,
                    ...
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LlamaParse.PipelineFile.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.PipelineFile>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LlamaParse.PipelineFile.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
