...
namespace LlamaParse
{
    public partial class IndexesClient
    {
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement s_SyncIndexApiV1IndexesIndexIdSyncPostSecurityRequirement0 =
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement[] s_SyncIndexApiV1IndexesIndexIdSyncPostSecurityRequirements =
            new global::LlamaParse.EndPointSecurityRequirement[]
            {                s_SyncIndexApiV1IndexesIndexIdSyncPostSecurityRequirement0,
            };
        partial void PrepareSyncIndexApiV1IndexesIndexIdSyncPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string indexId,
            global::System.Guid? projectId,
            global::System.Guid? organizationId,
            ref string? session);
        partial void PrepareSyncIndexApiV1IndexesIndexIdSyncPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::System.Guid? organizationId,
            string? session);
        partial void ProcessSyncIndexApiV1IndexesIndexIdSyncPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSyncIndexApiV1IndexesIndexIdSyncPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> SyncIndexApiV1IndexesIndexIdSyncPostAsync(
            string indexId,
        ...
        {
            var __response = await SyncIndexApiV1IndexesIndexIdSyncPostAsResponseAsync(
                indexId: indexId,
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LlamaParse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LlamaParse.AutoSDKHttpResponse<string>> SyncIndexApiV1IndexesIndexIdSyncPostAsResponseAsync(
            string indexId,
            global::System.Guid? projectId = default,
            global::System.Guid? organizationId = default,
            string? session = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareSyncIndexApiV1IndexesIndexIdSyncPostArguments(
            ...
            var __authorizations = global::LlamaParse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SyncIndexApiV1IndexesIndexIdSyncPostSecurityRequirements,
                operationName: "SyncIndexApiV1IndexesIndexIdSyncPostAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LlamaParse.PathBuilder(
                                path: $"/api/v1/indexes/{indexId}/sync",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSyncIndexApiV1IndexesIndexIdSyncPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LlamaParse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SyncIndexApiV1IndexesIndexIdSyncPost",
                                methodName: "SyncIndexApiV1IndexesIndexIdSyncPostAsync",
                                pathTemplate: "$\"/api/v1/indexes/{indexId}/sync\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSyncIndexApiV1IndexesIndexIdSyncPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSyncIndexApiV1IndexesIndexIdSyncPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
