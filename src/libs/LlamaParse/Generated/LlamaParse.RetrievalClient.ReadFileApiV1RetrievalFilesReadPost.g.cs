...
namespace LlamaParse
{
    public partial class RetrievalClient
    {
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement s_ReadFileApiV1RetrievalFilesReadPostSecurityRequirement0 =
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement[] s_ReadFileApiV1RetrievalFilesReadPostSecurityRequirements =
            new global::LlamaParse.EndPointSecurityRequirement[]
            {                s_ReadFileApiV1RetrievalFilesReadPostSecurityRequirement0,
            };
        partial void PrepareReadFileApiV1RetrievalFilesReadPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Guid? projectId,
            global::System.Guid? organizationId,
            ref string? session,
            global::LlamaParse.FileReadParams request);
        partial void PrepareReadFileApiV1RetrievalFilesReadPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? session,
            global::LlamaParse.FileReadParams request);
        partial void ProcessReadFileApiV1RetrievalFilesReadPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessReadFileApiV1RetrievalFilesReadPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await ReadFileApiV1RetrievalFilesReadPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareReadFileApiV1RetrievalFilesReadPostArguments(
            ...
            var __authorizations = global::LlamaParse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ReadFileApiV1RetrievalFilesReadPostSecurityRequirements,
                operationName: "ReadFileApiV1RetrievalFilesReadPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareReadFileApiV1RetrievalFilesReadPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LlamaParse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ReadFileApiV1RetrievalFilesReadPost",
                                methodName: "ReadFileApiV1RetrievalFilesReadPostAsync",
                                pathTemplate: "\"/api/v1/retrieval/files/read\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessReadFileApiV1RetrievalFilesReadPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessReadFileApiV1RetrievalFilesReadPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::LlamaParse.FileReadResult> ReadFileApiV1RetrievalFilesReadPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::LlamaParse.FileReadParams
            {
                IndexId = indexId,
                FileId = fileId,
                Offset = offset,
            ...
            return await ReadFileApiV1RetrievalFilesReadPostAsync(
                projectId: projectId,
                organizationId: organizationId,
                session: session,
                request: __request,
