...
namespace LlamaParse
{
    public partial class BetaClient
    {
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement s_ListBatchJobsApiV1BetaBatchProcessingGetSecurityRequirement0 =
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement[] s_ListBatchJobsApiV1BetaBatchProcessingGetSecurityRequirements =
            new global::LlamaParse.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::LlamaParse.BatchJobQueryResponse> ListBatchJobsApiV1BetaBatchProcessingGetAsync(
            string? directoryId = default,
            global::LlamaParse.BatchJobType? jobType = default,
            global::LlamaParse.BatchJobStatus? status = default,
            int? limit = default,
            int? offset = default,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LlamaParse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.BatchJobQueryResponse>> ListBatchJobsApiV1BetaBatchProcessingGetAsResponseAsync(
            string? directoryId = default,
            global::LlamaParse.BatchJobType? jobType = default,
            global::LlamaParse.BatchJobStatus? status = default,
            int? limit = default,
                    ...
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LlamaParse.BatchJobQueryResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.BatchJobQueryResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LlamaParse.BatchJobQueryResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
