            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::LlamaParse.FileQueryResponseV2.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::LlamaParse.FileQueryResponseV2.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
