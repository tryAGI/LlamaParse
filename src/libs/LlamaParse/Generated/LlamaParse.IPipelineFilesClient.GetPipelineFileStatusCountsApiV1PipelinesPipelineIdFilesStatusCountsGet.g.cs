...
namespace LlamaParse
{
    public partial interface IPipelineFilesClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LlamaParse.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.FileCountByStatusResponse>> GetPipelineFileStatusCountsApiV1PipelinesPipelineIdFilesStatusCountsGetAsResponseAsync(
            global::System.Guid pipelineId,
            global::System.Guid? dataSourceId = default,
            bool? onlyManuallyUploaded = default,
            string? session = default,
