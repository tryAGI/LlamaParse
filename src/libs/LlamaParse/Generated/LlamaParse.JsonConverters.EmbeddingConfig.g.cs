...
{
    /// <inheritdoc />
    public class EmbeddingConfigJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::LlamaParse.EmbeddingConfig>
    {
        /// <inheritdoc />
        public override global::LlamaParse.EmbeddingConfig Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::LlamaParse.EmbeddingModelConfigEmbeddingConfigDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::LlamaParse.EmbeddingModelConfigEmbeddingConfigDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::LlamaParse.EmbeddingModelConfigEmbeddingConfigDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::LlamaParse.AzureOpenAIEmbeddingConfig? azureEmbedding1 = default;
            if (discriminator?.Type == global::LlamaParse.EmbeddingModelConfigEmbeddingConfigDiscriminatorType.AzureEmbedding)
            {
            ...
            if (discriminator?.Type == global::LlamaParse.EmbeddingModelConfigEmbeddingConfigDiscriminatorType.CohereEmbedding)
            {
            ...
            if (discriminator?.Type == global::LlamaParse.EmbeddingModelConfigEmbeddingConfigDiscriminatorType.GeminiEmbedding)
            {
            ...
            if (discriminator?.Type == global::LlamaParse.EmbeddingModelConfigEmbeddingConfigDiscriminatorType.HuggingfaceApiEmbedding)
            {
            ...
            if (discriminator?.Type == global::LlamaParse.EmbeddingModelConfigEmbeddingConfigDiscriminatorType.VertexaiEmbedding)
            {
            ...
            if (discriminator?.Type == global::LlamaParse.EmbeddingModelConfigEmbeddingConfigDiscriminatorType.BedrockEmbedding)
            {
            ...
            var __value = new global::LlamaParse.EmbeddingConfig(
                discriminator?.Type,
                azureEmbedding1,
        ...
        public override void Write(
            ...
            global::LlamaParse.EmbeddingConfig value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
