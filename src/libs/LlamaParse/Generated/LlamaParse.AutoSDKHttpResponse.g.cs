...
namespace LlamaParse
{
    ...
    public sealed class AutoSDKConditionalResponse<T>
    {
        internal AutoSDKConditionalResponse(
            bool notModified,
            string? entityTag,
            global::LlamaParse.AutoSDKHttpResponse<T>? response)
        {
        ...
        public global::LlamaParse.AutoSDKHttpResponse<T>? Response { get; }
    }
    ...
    public static class AutoSDKConditionalRequests
    {
        ...
        /// </summary>
        public static async global::System.Threading.Tasks.Task<global::LlamaParse.AutoSDKConditionalResponse<T>> SendAsync<T>(
            global::System.Func<global::LlamaParse.AutoSDKRequestOptions, global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<global::LlamaParse.AutoSDKHttpResponse<T>>> send,
            string? entityTag = null,
            global::LlamaParse.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new global::LlamaParse.AutoSDKConditionalResponse<T>(
                    notModified: false,
                    entityTag: GetEntityTag(response.Headers),
                    response: response);
            }
            catch (global::LlamaParse.ApiException exception)
        ...
        private static global::LlamaParse.AutoSDKRequestOptions CloneRequestOptions(
            global::LlamaParse.AutoSDKRequestOptions? source)
        {
            var clone = new global::LlamaParse.AutoSDKRequestOptions();
            if (source == null)
            {
                return clone;
            }
