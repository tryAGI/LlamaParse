...
namespace LlamaParse
{
    public partial class LlamaExtractClient
    {
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement s_ListExtractRunsApiV1ExtractionRunsGetSecurityRequirement0 =
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement[] s_ListExtractRunsApiV1ExtractionRunsGetSecurityRequirements =
            new global::LlamaParse.EndPointSecurityRequirement[]
            {                s_ListExtractRunsApiV1ExtractionRunsGetSecurityRequirement0,
            };
        partial void PrepareListExtractRunsApiV1ExtractionRunsGetArguments(
        ...
        partial void ProcessListExtractRunsApiV1ExtractionRunsGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LlamaParse.PaginatedExtractRunsResponse> ListExtractRunsApiV1ExtractionRunsGetAsync(
            global::System.Guid extractionAgentId,
            int? skip = default,
            int? limit = default,
        ...
        {
            var __response = await ListExtractRunsApiV1ExtractionRunsGetAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LlamaParse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.PaginatedExtractRunsResponse>> ListExtractRunsApiV1ExtractionRunsGetAsResponseAsync(
            global::System.Guid extractionAgentId,
            int? skip = default,
            int? limit = default,
            string? status = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListExtractRunsApiV1ExtractionRunsGetArguments(
            ...
            var __authorizations = global::LlamaParse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListExtractRunsApiV1ExtractionRunsGetSecurityRequirements,
                operationName: "ListExtractRunsApiV1ExtractionRunsGetAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LlamaParse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListExtractRunsApiV1ExtractionRunsGet",
                                methodName: "ListExtractRunsApiV1ExtractionRunsGetAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListExtractRunsApiV1ExtractionRunsGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListExtractRunsApiV1ExtractionRunsGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LlamaParse.PaginatedExtractRunsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.PaginatedExtractRunsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LlamaParse.PaginatedExtractRunsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
