...
namespace LlamaParse
{
    public partial class LlamaExtractClient
    {
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement s_ExtractStatelessApiV1ExtractionRunPostSecurityRequirement0 =
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement[] s_ExtractStatelessApiV1ExtractionRunPostSecurityRequirements =
            new global::LlamaParse.EndPointSecurityRequirement[]
            {                s_ExtractStatelessApiV1ExtractionRunPostSecurityRequirement0,
            };
        partial void PrepareExtractStatelessApiV1ExtractionRunPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Guid? projectId,
            global::System.Guid? organizationId,
            ref string? session,
            global::LlamaParse.ExtractStatelessRequest request);
        partial void PrepareExtractStatelessApiV1ExtractionRunPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? session,
            global::LlamaParse.ExtractStatelessRequest request);
        partial void ProcessExtractStatelessApiV1ExtractionRunPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessExtractStatelessApiV1ExtractionRunPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LlamaParse.ExtractJob> ExtractStatelessApiV1ExtractionRunPostAsync(
        ...
        {
            var __response = await ExtractStatelessApiV1ExtractionRunPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LlamaParse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.ExtractJob>> ExtractStatelessApiV1ExtractionRunPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareExtractStatelessApiV1ExtractionRunPostArguments(
            ...
            var __authorizations = global::LlamaParse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ExtractStatelessApiV1ExtractionRunPostSecurityRequirements,
                operationName: "ExtractStatelessApiV1ExtractionRunPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareExtractStatelessApiV1ExtractionRunPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LlamaParse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ExtractStatelessApiV1ExtractionRunPost",
                                methodName: "ExtractStatelessApiV1ExtractionRunPostAsync",
                                pathTemplate: "\"/api/v1/extraction/run\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessExtractStatelessApiV1ExtractionRunPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessExtractStatelessApiV1ExtractionRunPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LlamaParse.ExtractJob.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.ExtractJob>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LlamaParse.ExtractJob.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ExtractStatelessApiV1ExtractionRunPostAsync(
                projectId: projectId,
                organizationId: organizationId,
                session: session,
                request: __request,
