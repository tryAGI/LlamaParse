...
namespace LlamaParse
{
    public partial class RetrievalClient
    {
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement s_GrepFileApiV1RetrievalFilesGrepPostSecurityRequirement0 =
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement[] s_GrepFileApiV1RetrievalFilesGrepPostSecurityRequirements =
            new global::LlamaParse.EndPointSecurityRequirement[]
            {                s_GrepFileApiV1RetrievalFilesGrepPostSecurityRequirement0,
            };
        partial void PrepareGrepFileApiV1RetrievalFilesGrepPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Guid? projectId,
            global::System.Guid? organizationId,
            ref string? session,
            global::LlamaParse.FileGrepParams request);
        partial void PrepareGrepFileApiV1RetrievalFilesGrepPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? session,
            global::LlamaParse.FileGrepParams request);
        partial void ProcessGrepFileApiV1RetrievalFilesGrepPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGrepFileApiV1RetrievalFilesGrepPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LlamaParse.FileGrepResult> GrepFileApiV1RetrievalFilesGrepPostAsync(
        ...
        {
            var __response = await GrepFileApiV1RetrievalFilesGrepPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LlamaParse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.FileGrepResult>> GrepFileApiV1RetrievalFilesGrepPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGrepFileApiV1RetrievalFilesGrepPostArguments(
            ...
            var __authorizations = global::LlamaParse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GrepFileApiV1RetrievalFilesGrepPostSecurityRequirements,
                operationName: "GrepFileApiV1RetrievalFilesGrepPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGrepFileApiV1RetrievalFilesGrepPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LlamaParse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GrepFileApiV1RetrievalFilesGrepPost",
                                methodName: "GrepFileApiV1RetrievalFilesGrepPostAsync",
                                pathTemplate: "\"/api/v1/retrieval/files/grep\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGrepFileApiV1RetrievalFilesGrepPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGrepFileApiV1RetrievalFilesGrepPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LlamaParse.FileGrepResult.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.FileGrepResult>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LlamaParse.FileGrepResult.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::LlamaParse.FileGrepResult> GrepFileApiV1RetrievalFilesGrepPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::LlamaParse.FileGrepParams
            {
                PageSize = pageSize,
                PageToken = pageToken,
                IndexId = indexId,
            ...
            return await GrepFileApiV1RetrievalFilesGrepPostAsync(
                projectId: projectId,
                organizationId: organizationId,
                session: session,
                request: __request,
