...
{
    /// <inheritdoc />
    public class ItemsItem3JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::LlamaParse.ItemsItem3>
    {
        /// <inheritdoc />
        public override global::LlamaParse.ItemsItem3 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::LlamaParse.FormSectionItemDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::LlamaParse.FormSectionItemDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::LlamaParse.FormSectionItemDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::LlamaParse.FormSection? section = default;
            if (discriminator?.Type == global::LlamaParse.FormSectionItemDiscriminatorType.Section)
            {
            ...
            if (discriminator?.Type == global::LlamaParse.FormSectionItemDiscriminatorType.Field)
            {
            ...
            if (discriminator?.Type == global::LlamaParse.FormSectionItemDiscriminatorType.Table)
            {
        ...
        public override void Write(
            ...
            global::LlamaParse.ItemsItem3 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
