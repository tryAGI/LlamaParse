...
namespace LlamaParse
{
    public partial class BetaClient
    {
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement s_CreateSplitJobApiV1BetaSplitJobsPostSecurityRequirement0 =
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement[] s_CreateSplitJobApiV1BetaSplitJobsPostSecurityRequirements =
            new global::LlamaParse.EndPointSecurityRequirement[]
            {                s_CreateSplitJobApiV1BetaSplitJobsPostSecurityRequirement0,
            };
        partial void PrepareCreateSplitJobApiV1BetaSplitJobsPostArguments(
        ...
        partial void ProcessCreateSplitJobApiV1BetaSplitJobsPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await CreateSplitJobApiV1BetaSplitJobsPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateSplitJobApiV1BetaSplitJobsPostArguments(
            ...
            var __authorizations = global::LlamaParse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateSplitJobApiV1BetaSplitJobsPostSecurityRequirements,
                operationName: "CreateSplitJobApiV1BetaSplitJobsPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateSplitJobApiV1BetaSplitJobsPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LlamaParse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateSplitJobApiV1BetaSplitJobsPost",
                                methodName: "CreateSplitJobApiV1BetaSplitJobsPostAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateSplitJobApiV1BetaSplitJobsPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateSplitJobApiV1BetaSplitJobsPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreateSplitJobApiV1BetaSplitJobsPostAsync(
                projectId: projectId,
                organizationId: organizationId,
                session: session,
                request: __request,
