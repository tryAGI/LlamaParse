                    ...
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        (global::System.Collections.Generic.IList<global::LlamaParse.DataSink>?)global::System.Text.Json.JsonSerializer.Deserialize(__content, typeof(global::System.Collections.Generic.IList<global::LlamaParse.DataSink>), JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        (global::System.Collections.Generic.IList<global::LlamaParse.DataSink>?)await global::System.Text.Json.JsonSerializer.DeserializeAsync(__content, typeof(global::System.Collections.Generic.IList<global::LlamaParse.DataSink>), JsonSerializerContext).ConfigureAwait(false) ??
