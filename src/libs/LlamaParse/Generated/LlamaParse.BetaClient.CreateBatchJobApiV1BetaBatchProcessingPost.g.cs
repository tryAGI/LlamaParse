...
namespace LlamaParse
{
    public partial class BetaClient
    {
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement s_CreateBatchJobApiV1BetaBatchProcessingPostSecurityRequirement0 =
        ...
        private static readonly global::LlamaParse.EndPointSecurityRequirement[] s_CreateBatchJobApiV1BetaBatchProcessingPostSecurityRequirements =
            new global::LlamaParse.EndPointSecurityRequirement[]
            {                s_CreateBatchJobApiV1BetaBatchProcessingPostSecurityRequirement0,
            };
        partial void PrepareCreateBatchJobApiV1BetaBatchProcessingPostArguments(
            ...
            ref string? session,
            global::LlamaParse.BatchJobCreateRequest request);
        ...
        public async global::System.Threading.Tasks.Task<global::LlamaParse.BatchJobResponse> CreateBatchJobApiV1BetaBatchProcessingPostAsync(
        ...
        {
            var __response = await CreateBatchJobApiV1BetaBatchProcessingPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LlamaParse.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.BatchJobResponse>> CreateBatchJobApiV1BetaBatchProcessingPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::LlamaParse.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateBatchJobApiV1BetaBatchProcessingPostSecurityRequirements,
                operationName: "CreateBatchJobApiV1BetaBatchProcessingPostAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LlamaParse.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateBatchJobApiV1BetaBatchProcessingPost",
                                methodName: "CreateBatchJobApiV1BetaBatchProcessingPostAsync",
                    ...
                    await global::LlamaParse.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LlamaParse.BatchJobResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LlamaParse.AutoSDKHttpResponse<global::LlamaParse.BatchJobResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LlamaParse.BatchJobResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::LlamaParse.BatchJobResponse> CreateBatchJobApiV1BetaBatchProcessingPostAsync(
            global::LlamaParse.AnyOf<global::LlamaParse.BatchParseJobRecordCreate, global::LlamaParse.ClassifyJob> jobConfig,
            global::System.Guid? projectId = default,
            global::System.Guid? organizationId = default,
            string? temporalNamespace = default,
            string? session = default,
